...
public class Residuo extends BaseEntity {
  ...
  public Residuo(String codigo, String composicionQuimica, int cantidad, LocalDateTime fechaGeneracion,
      Productor productor, Envase envase, Traslado traslado, Tratamiento tratamiento, Long id, LocalDateTime fechaCreacion,  int estado) {
