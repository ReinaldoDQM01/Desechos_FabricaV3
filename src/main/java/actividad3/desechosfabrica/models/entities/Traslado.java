...
public class Traslado extends BaseEntity {
  ...
  @Column(name = "fecha_llegata")
  private LocalDateTime fechaLlegada;
  private double coste;

  public Traslado(Residuo residuo, int cantidadTrasladada, Envase envase, LocalDateTime fechaLlegada, double coste,
      long id, LocalDateTime fechaCreacion, int estado) {
