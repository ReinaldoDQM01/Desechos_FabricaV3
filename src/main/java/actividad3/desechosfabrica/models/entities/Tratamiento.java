...
public class Tratamiento extends BaseEntity {
  ...
  public Tratamiento(String descripcion, LocalDateTime fechaInicio, LocalDateTime fechaFin, String nombreDestinoFinal,
      String direccionDestinoFinal, Residuo residuo, Long id, LocalDateTime fechaCreacion, int estado) {
